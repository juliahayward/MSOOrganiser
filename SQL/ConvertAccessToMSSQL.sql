...
(
	...
	Score INT, 
	Rank INT,
	CONSTRAINT [Seedings$PrimaryKey] PRIMARY KEY CLUSTERED 
	(
		[Id] ASC
	) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]) 
ON [PRIMARY]

ALTER TABLE Seedings ADD FOREIGN KEY (ContestantId) REFERENCES Names ([Mind Sport Id])
